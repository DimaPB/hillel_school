...
class TestWaiters:
    ...
    def test_connection(self):
        ...
        WebDriverWait(self.driver, timeout=10).until(ec.visibility_of_element_located(visible_invisible_button_loc))
    ...
    def test_connection_enable(self):
        self.driver.maximize_window()
        self.driver.get("https://demoqa.com/dynamic-properties")
        enable_disable_button_loc = (By.CSS_SELECTOR, "#enableAfter")
        WebDriverWait(self.driver, timeout=10).until(ec.element_to_be_clickable(enable_disable_button_loc))
        enable_disable_button: WebElement = self.driver.find_element(*enable_disable_button_loc)
        enable_disable_button.click()
        assert enable_disable_button.is_enabled()
